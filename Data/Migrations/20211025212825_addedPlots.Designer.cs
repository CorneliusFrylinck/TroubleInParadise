...
namespace TroubleInParadise.Data.Migrations
{
    ...
    [Migration("20211025212825_addedPlots")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TroubleInParadise.Models.Plot_Type", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("ResourceCollectionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TroubleInParadise.Models.Server_Plots", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TroubleInParadise.Models.Plot_Type", b =>
                {
                    b.HasOne("TroubleInParadise.Models.ResourceCollection", "ResourceCollection")
                        .WithMany()
                        .HasForeignKey("ResourceCollectionId");

                    b.Navigation("ResourceCollection");
                });
            ...
            modelBuilder.Entity("TroubleInParadise.Models.Server_Plots", b =>
                {
                    b.HasOne("TroubleInParadise.Models.Plot_Type", "PlotType")
                        .WithMany()
                        .HasForeignKey("PlotTypeId");

                    b.HasOne("TroubleInParadise.Models.Server", null)
                        .WithMany("server_Plots")
                        .HasForeignKey("ServerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TroubleInParadise.Models.Location", "endLocation")
                        .WithMany()
                        .HasForeignKey("endLocationId");

                    b.HasOne("TroubleInParadise.Models.Location", "startLocation")
                        .WithMany()
